# mcp-slim-guard — Schema Compressor
...
mcp-slim-guard init --compressor light

# Or edit mcp-slim-guard.yml directly
compressor:
  enabled: true
  level: light
```
...
```bash
mcp-slim-guard init --compressor off --lazy --lazy-budget 8
```
...
| Feature       | mcp-slim-guard                                      | slim-mcp                                     | mcp-compressor          |
| ------------- | --------------------------------------------------- | -------------------------------------------- | ----------------------- |
