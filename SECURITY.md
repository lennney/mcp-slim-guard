...
micro-mcp is a security tool — the safety of our users is our top priority.

If you discover a security vulnerability, please **do NOT** file a public GitHub issue. Instead, send a description to:

**GitHub Issues**: [github.com/lennney/micro-mcp/issues](https://github.com/lennney/micro-mcp/issues)  
...
micro-mcp is a security proxy that enforces policies between AI agents and MCP servers. The following are in scope for security reports:
...
- Attacks requiring physical access to the machine running micro-mcp

## Recognition

We maintain a list of security researchers who have helped improve micro-mcp's security in our [CHANGELOG](./CHANGELOG.md).
